            ...
            <ul className="space-y-0">
              {CONTACT_LINKS.map((link) => (
                <li key={link.label}>
                  ...
                  >
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.2em] text-[#4A4238] mb-1">
                        {link.label}
                      </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              <div className="space-y-8">
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] uppercase tracking-[0.2em] text-[#4A4238]">
                    Seu nome
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-[10px] text-[#4A4238] leading-relaxed">
